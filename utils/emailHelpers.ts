 ...
 */
export function htmlNewReservationClient(params?: { url?: string; host?: string; origin?: string; email?: string, theme?: any }) {
...
export function htmlNewReservation(params?: { url?: string; host?: string; origin?: string; email?: string, theme?: any }) {
    const { url, host, theme, origin } = params
    const escapedHost = host?.replace(/\./g, "&#8203;.")
