...
const CreateMedIssue = ({ user }) => {
  ...
  return (
    <Layout>
      <Content>
        <h1>Create New Medical Issue</h1>
        <StyledLabel htmlFor="name">Name of Medical Issue</StyledLabel>
        <StyledInput
          autoFocus
            ...
            onSave={(html, editor) => {
              ...
              fetch("/api/medical-issue", {
                ...
                .then(() => {
                  ...
                  message.success("Medical Issue Created Successfully");
                })
                .catch((err) => console.log(err));
            }}
            buttonText="Add New Medical Issue"
          />
        </EditForm>
      </Content>
    </Layout>
